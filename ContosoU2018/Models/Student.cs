...
namespace ContosoU2018.Models
{
    public class Student:Person//Student inherits from Person
    {
         ...
         * student will hold all of the enrollments that are related to that student.
         * 
         ...
         * Note: lazy loading is not yet available in EF Core (but has is EF 5, 6...)
         * 
         * Lazy loading is not enabled by default - so that means that when a particular student
